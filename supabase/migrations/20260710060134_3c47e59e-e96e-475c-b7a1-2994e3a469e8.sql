...
create index academic_chapters_status_idx on public.academic_chapters (status);
grant select, insert, update, delete on public.academic_chapters to authenticated;
